...
public class sevgilimTirtil2 {
        ...
        //olabilecek hemen hemen her durum için method oluşturup gerekli yerlerde o methodları call etmeyi denedim.
        ...
        {
        System.out.println("Soru 2: Sevgilin bir tırtıl olarak kozaya giriyor sonrasında kozadan çıkana kadar onu sever miydin?" + "Evet = 1, Hayır = 2");
         Scanner userInput = new Scanner(System.in);
         int userDecision = userInput.nextInt();
            return userDecision;
        }
        ...
        {
        System.out.println("Soru 3: Sevgilin kozadan çirkin berbat kapkara bir kelebek olarak çıktı. Ona olan sevgin azalır mıydı?" + "Evet = 1, Hayır = 2");
         Scanner userInput = new Scanner(System.in);
         int userDecision = userInput.nextInt();
            return userDecision;
        }
        ...
        public static int endingGame(){ //oyun sonunda yeniden oynamak istiyor mu
            Scanner userInput = new Scanner(System.in);
    ...
    public static void main(String args[]){
        ...
        //iç içe if else kullanmaktansa oyunu tek çizgi halinde devam eden ya da kaybedince ana döngüyü bitiren bir formata soktum.
        //bu mantık ile ağaç gibi dallanma yapmadığım için çok daha karmaşık (daha sonra yapmayı planladığım bandersnatch oyunu gibi),
        //aşırı kompleks dallandırmaları kolaylıkla yapabileceğimi fakettim. çünkü aslında lineer bir hat oluşturabiliyorum böyle.
        while (reloadGame){
            while (isTheGameOn){
                ...
                int userDecision = question1();   //birinci soru için methodu çağırdım
             if (userDecision == 1)
                    { }
                else {
                    losingScenario();
                ...
                userDecision = question2();   //ikinci soru için methodu çağırdım
             if (userDecision == 1)
                    {  }
                else {
                    losingScenario();
                ...
                userDecision = question3();   //üçüncü soru için methodu çağırdım
             if (userDecision == 1)
                    {  }
                else {
                ...
                userDecision = question4();   //dördüncü soru için methodu çağırdım
                if (userDecision == 1)
                       { losingScenario();
                        isTheGameOn = (false); 
                        break; }
            ...
            int replay = endingGame();
            if (replay == 1){  reloadGame = true; isTheGameOn=true;}
            else {  reloadGame = false;}
        }
    }
